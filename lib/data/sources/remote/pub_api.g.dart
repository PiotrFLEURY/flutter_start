...
class _PubApi implements PubApi {
  ...
  Future<PackageCompletion> getPackageCompletion() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PackageCompletion>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Package> getPackage(String packageName) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Package>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Score> getScore(String packageName) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Score>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
